        ...
        <form action="" method="post" id="dokan-add-new-product-form">
            <div class="product-form-container">
                ...
                <div class="product-full-container">
                    <div class="dokan-clearfix">
                        <div class="dokan-form-group dokan-clearfix dokan-attributes-container">
                            <div class="content-half-part">
                                <select name="pa_size" id="pa_size" class="dokan-form-control dokan-select2" style="width:100%;">
                            ...
                            <div class="content-half-part">
                                <select name="pa_condition" id="pa_condition" class="dokan-form-control dokan-select2" style="width:100%;">
                                    <option value="">Select a product condition</option>
                                    <?php
                                    $terms = get_terms( array( 'taxonomy' => 'pa_condition', 'hide_empty' => false ) );
                                    if ( !is_wp_error( $terms ) ) {
                                        foreach( $terms as $term ) {
                                            echo '<option value="'.$term->term_id.'">'.$term->name.'</option>';
                                        }
