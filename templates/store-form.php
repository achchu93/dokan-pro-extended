...
<?php
    ...
    $dokan_store_discount_rate  = get_user_meta( $current_user, 'store_discount_rate', true);
    $dokan_store_discount_start = get_user_meta( $current_user, 'store_discount_start', true);
    $dokan_store_discount_end   = get_user_meta( $current_user, 'store_discount_end', true);
?>
<?php do_action( 'dokan_settings_before_form', $current_user, $profile_info ); ?>
    ...
    <form method="post" id="store-form"  action="" class="dokan-form-horizontal">
        ...
        <div class="dokan-form-group store-discount-rate">
            <label class="dokan-w3 control-label" for="dokan-store-discount-rate">
                <?php esc_html_e( 'Sale', 'dokan-lite' ); ?>
            </label>
            <div class="dokan-w6" style="width: auto">
                <div class="dokan-form-group">
                    <input type="number" class="dokan-form-control input-md" name="dokan_store_discount_rate" placeholder="<?php esc_attr_e( 'Sale percentage', 'dokan-lite' ) ?>" value="<?php echo esc_attr( $dokan_store_discount_rate ); ?>">
                </div>
            </div>
        </div>

        <div class="dokan-form-group store-discount-start">
            <label class="dokan-w3 control-label" for="dokan-store-discount-start">
                <?php esc_html_e( 'Sale From', 'dokan-lite' ); ?>
            </label>
            <div class="dokan-w6" style="width: auto">
                <div class="dokan-form-group">
                    <input type="text" class="dokan-form-control input-md" id="dokan-store-discount-start" name="dokan_store_discount_start" placeholder="<?php esc_attr_e( 'yyyy-mm-dd', 'dokan-lite' ) ?>" value="<?php echo esc_attr( !empty( $dokan_store_discount_start ) ? date( 'Y-m-d', strtotime( $dokan_store_discount_start ) ) : '' ); ?>" maxlenght="10" pattern="[0-9]{4}-(0[1-9]|1[012])-(0[1-9]|1[0-9]|2[0-9]|3[01])">
                </div>
            </div>
        </div>

        <div class="dokan-form-group store-discount-end">
            <label class="dokan-w3 control-label" for="dokan-store-discount-end">
                <?php esc_html_e( 'Sale To', 'dokan-lite' ); ?>
            </label>
            <div class="dokan-w6" style="width: auto">
                <div class="dokan-form-group">
                    <input type="text" class="dokan-form-control input-md" id="dokan-store-discount-end" name="dokan_store_discount_end" placeholder="<?php esc_attr_e( 'yyyy-mm-dd', 'dokan-lite' ) ?>" value="<?php echo esc_attr( !empty( $dokan_store_discount_end ) ? date( 'Y-m-d', strtotime( $dokan_store_discount_end ) ) : '' ); ?>" maxlenght="10" pattern="[0-9]{4}-(0[1-9]|1[012])-(0[1-9]|1[0-9]|2[0-9]|3[01])">
                </div>
            </div>
        </div>
